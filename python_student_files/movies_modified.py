#!/usr/bin/env python3
#===========================================================================
# Code Practice Lab 7 - Movies
# Leverage a Python List data structure, and functions
# DEV 108 - 34634
# Mario Rodriguez
# February 22, 2025
# TODO: 
#   - Add 'find' command that searches for movies by input year
#   - Add column for 'movie price'
#===========================================================================
...
def add(movie_list):
    name = input("Name: ")
    year = input("Year: ")
    price = input('Price: ') # added price column to record
